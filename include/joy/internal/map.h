 ...
 * weak ordering.
 */
#define JOY_MAP(key_comp) (key_comp, JOY_SET(key_comp))
 ...
 */
#define JOY_MAP_KEY_COMP(map) CHAOS_PP_TUPLE_ELEM(2, 0, map)

#define JOY_I_MAP_SET(map) CHAOS_PP_TUPLE_ELEM(2, 1, map)
#define JOY_I_MAP_SET_SET(map, set) CHAOS_PP_TUPLE_REPLACE(1, map, set)

#define JOY_I_MAP_CELL(key, value) (key, value)
#define JOY_I_MAP_CELL_KEY(cell) CHAOS_PP_TUPLE_ELEM(2, 0, cell)
#define JOY_I_MAP_CELL_VALUE(cell) CHAOS_PP_TUPLE_ELEM(2, 1, cell)
