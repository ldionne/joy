/*!
 * This file defines a macro to retrieve the values stored in a map.
 *
 * @author Louis Dionne
 */

#ifndef JOY_MAP_VALUES_H
#define JOY_MAP_VALUES_H
...
/*!
 * Return the values contained in a map in a sequence.
 */
